...
- Prompt templates belong under `apps/backend/prompts/`.
...
Touch primarily:
- `apps/frontend/features/collaboration`
- `apps/frontend/services`
...
Touch primarily:
- `apps/backend/api/routes/documents*`
...
Touch primarily:
- `apps/backend/api/routes/auth*`
- `apps/backend/api/routes/permissions*`
- `apps/backend/services`
- `apps/backend/repositories`
- `apps/backend/schemas`
